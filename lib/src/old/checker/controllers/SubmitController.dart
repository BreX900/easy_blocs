...
import 'package:easy_blocs/src/old/checker/controllers/FormHandler.dart';
...
class SubmitController<V> implements Finger {
  ...
  CacheSubject<SubmitData> _submitController =
      CacheSubject.seeded(SubmitData(event: SubmitEvent.WAITING));
