...
import 'package:easy_blocs/src/old/checker/checkers/PhoneNumberChecker.dart';
import 'package:easy_blocs/src/old/checker/widget/IntField.dart';
...
const PHONE_NUMBER_DECORATION = const TranslationsInputDecoration(
  ...
  translationsHintText: const TranslationsConst(it: "Numero di Telefono", en: "Phone Number"),
);
